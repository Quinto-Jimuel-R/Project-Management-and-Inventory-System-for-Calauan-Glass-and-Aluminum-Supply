...
<script>
    $(document).ready(function() 
    {
        ...
        $('.customer-purchase-link').click(function(e) {
            e.preventDefault();
            ...
            $.ajax({
                type: "POST",
                url: "add.php?action=customer-purchase-link",
                data: { userId: userId },
                success: function (response) {
                    window.location.href = 'customer_project.php';
                }
            });
        });

        $('.customer-profile-link').click(function(e) {
            e.preventDefault();
            ...
            $.ajax({
                type: "POST",
                url: "add.php?action=customer-profile-link",
                data: { userId: userId },
                success: function (response) {
