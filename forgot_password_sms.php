    ...
    <div class="card mx-3" style="width: 500px;">
        <div class="card-body p-3">
            <div class="text-center mb-4">
                ...
                <p>Please enter the phone number linked with your account.</p>
            </div>

            <form action="sendOTPSms.php" method="POST" class="px-4">
                <div class="row mb-2">
                    <label for="phoneNumber" class="col-md-4 col-form-label p-0">Phone Number</label>
                    <input id="phoneNumber" type="text" class="form-control rounded-0 py-2" name="phoneNumber" required>
                </div>
                <div class="row mt-2">
